...
export const AVAILABLE_VARIABLES: Record<NotificationKey, VariableDoc[]> = {
  ...
  bod: [
    ...
    { name: "sales_line", description: "Last 7d (appointment-date lens): booked · schedule rate (scheduled/booked) · show rate ((scheduled−no-show)/scheduled) · taken · follow up · deal (conv%) · cancel · no show · empty. Cancel includes not interested + unqualified; taken excludes them." },
    { name: "closer_lines", description: "Per-closer last-7d breakdown (booked, schedule rate, show rate, taken, follow up, deal conv%, cancel, no show, empty), one bullet each." },
  ...
  eod: [
    ...
    { name: "sales_line", description: "Today (appointment-date lens): booked · schedule rate (scheduled/booked) · show rate ((scheduled−no-show)/scheduled) · taken · follow up · deal (conv%) · cancel · no show · empty. Cancel includes not interested + unqualified; taken excludes them." },
