...
export const AVAILABLE_VARIABLES: Record<NotificationKey, VariableDoc[]> = {
  ...
  bod: [
    ...
    { name: "sales_line", description: "Last 7d (appointment-date lens): scheduled · qualified (qual rate = qualified/scheduled) · taken (show rate = taken/qualified) · deal (conv%) · follow up · CQC (spend/qualified, team line only). Qualified = scheduled − cancellations − not interested − unqualified; taken excludes NI/UQ." },
    { name: "closer_lines", description: "Per-closer last-7d breakdown (scheduled, qualified + qual rate, taken + show rate, deal conv%, follow up), one bullet each." },
  ...
  eod: [
    ...
    { name: "sales_line", description: "Today (appointment-date lens): scheduled · qualified (qual rate = qualified/scheduled) · taken (show rate = taken/qualified) · deal (conv%) · follow up · CQC (spend/qualified, team line only). Qualified = scheduled − cancellations − not interested − unqualified; taken excludes NI/UQ." },
