...
export const DICTIONARY = {
  ...
  "zoom.label": { nl: "Zoom", en: "Zoom" },
  "zoom.in": { nl: "Inzoomen", en: "Zoom in" },
  "zoom.out": { nl: "Uitzoomen", en: "Zoom out" },
  "zoom.reset": { nl: "Herstel naar 100%", en: "Reset to 100%" },
  ...
  "inbox.shell.state.closed_title": { nl: "Ticket sluiten", en: "Close ticket" },
  "inbox.shell.state.group": { nl: "Ticketstatus", en: "Ticket status" },
  "inbox.shell.state.current": { nl: "Status: {label}", en: "Status: {label}" },
  "inbox.shell.header.title": { nl: "Inbox", en: "Inbox" },
  "inbox.shell.action.new": { nl: "Nieuw", en: "New" },
  "inbox.shell.rail.show": { nl: "Toon zijbalk", en: "Show sidebar" },
  "inbox.shell.rail.hide": { nl: "Verberg zijbalk", en: "Hide sidebar" },
  "inbox.shell.search.placeholder": { nl: "Zoek tickets — naam, klant of bericht…", en: "Search tickets — name, client, or message…" },
  "inbox.shell.search.clear": { nl: "Zoekopdracht wissen", en: "Clear search" },
  "inbox.shell.search.scope_label": { nl: "Zoeken in:", en: "Search in:" },
  "inbox.shell.search.scope_this": { nl: "Dit kanaal", en: "This channel" },
  "inbox.shell.search.scope_all": { nl: "Alle kanalen", en: "All channels" },
  "inbox.shell.empty.search": { nl: "Geen tickets komen overeen met je zoekopdracht.", en: "No tickets match your search." },
  "inbox.shell.empty.mentioned": { nl: "Geen tickets vermelden je op dit moment.", en: "No tickets mention you right now." },
  "inbox.shell.empty.no_channels": { nl: "Geen kanalen gekoppeld — voeg ze toe in Account-instellingen.", en: "No channels connected — add them in Account settings." },
  "inbox.shell.empty.view": { nl: "Geen tickets in deze weergave.", en: "No tickets in this view." },
  "inbox.shell.empty.view_channel": { nl: "Geen tickets op dit kanaal in deze weergave.", en: "No tickets on this channel in this view." },
  "inbox.shell.detail.empty": { nl: "Selecteer een item om het hier te openen", en: "Select an item to open it here" },
  "inbox.shell.feed.empty": { nl: "Niets hier", en: "Nothing here" },
  "inbox.shell.feed.item": { nl: "item", en: "item" },
  "inbox.shell.feed.items": { nl: "items", en: "items" },
  "inbox.shell.checkbox.mention_done": { nl: "Vink mention af", en: "Mark mention done" },
  "inbox.shell.checkbox.mention_todo": { nl: "Mention terug op to-do", en: "Mark mention as to-do" },
  "inbox.shell.checkbox.ticket_close": { nl: "Ticket sluiten", en: "Close ticket" },
  "inbox.shell.checkbox.ticket_reopen": { nl: "Ticket heropenen", en: "Reopen ticket" },
  ...
  "inbox.card.mark_done": { nl: "Markeer als klaar", en: "Mark as done" },
  "inbox.card.mark_not_done": { nl: "Markeer als niet klaar", en: "Mark as not done" },
  "inbox.card.reply": { nl: "Antwoord", en: "Reply" },
  "inbox.card.reply_count": { nl: "{n} antwoord", en: "{n} reply" },
  "inbox.card.reply_count_plural": { nl: "{n} antwoorden", en: "{n} replies" },
  "inbox.card.loading_replies": { nl: "Antwoorden laden…", en: "Loading replies…" },
  "inbox.card.reply_placeholder": { nl: "Schrijf een antwoord en noem anderen met @", en: "Write a reply and mention others with @" },

  // ─── Inbox chat pane (thread list, thread view, composer) ─────────────
  "inbox.chat.filter.unread": { nl: "Ongelezen", en: "Unread" },
  "inbox.chat.filter.all": { nl: "Alle gesprekken", en: "All conversations" },
  "inbox.chat.filter.snoozed": { nl: "Snoozed", en: "Snoozed" },
  "inbox.chat.filter.archived": { nl: "Gearchiveerd", en: "Archived" },
  "inbox.chat.empty.client_convos": { nl: "clientgesprekken", en: "client conversations" },
  "inbox.chat.empty.team_convos": { nl: "teamgesprekken", en: "team conversations" },
  "inbox.chat.empty.no_unread_client": { nl: "Geen ongelezen clientgesprekken.", en: "No unread client conversations." },
  "inbox.chat.empty.no_unread_team": { nl: "Geen ongelezen teamgesprekken.", en: "No unread team conversations." },
  "inbox.chat.empty.no_client_yet": { nl: "Nog geen clientgesprekken.", en: "No client conversations yet." },
  "inbox.chat.empty.no_team_yet": { nl: "Nog geen teamgesprekken.", en: "No team conversations yet." },
  "inbox.chat.empty.sub_trengo": { nl: "Trengo-berichten verschijnen hier zodra webhooks binnenkomen.", en: "Trengo messages will appear here once webhooks fire." },
  "inbox.chat.empty.sub_slack": { nl: "Slack-berichten verschijnen hier zodra webhooks binnenkomen.", en: "Slack messages will appear here once webhooks fire." },
  "inbox.chat.empty.sub_switch": { nl: "Wissel van tabblad om andere gesprekken te zien.", en: "Try switching tabs to see other conversations." },
  "inbox.chat.selected_suffix": { nl: "geselecteerd", en: "selected" },
  "inbox.chat.conversation": { nl: "gesprek", en: "conversation" },
  "inbox.chat.conversations": { nl: "gesprekken", en: "conversations" },
  "inbox.chat.clear": { nl: "Wissen", en: "Clear" },
  "inbox.chat.deselect": { nl: "Deselecteren", en: "Deselect" },
  "inbox.chat.select_bulk": { nl: "Selecteer voor bulk-actie", en: "Select for bulk action" },
  "inbox.chat.unstar": { nl: "Ster verwijderen", en: "Unstar" },
  "inbox.chat.star": { nl: "Ster", en: "Star" },
  "inbox.chat.snooze_remove": { nl: "Verwijder snooze", en: "Remove snooze" },
  "inbox.chat.snooze_8h": { nl: "Snooze 8u", en: "Snooze 8h" },
  "inbox.chat.back_to_inbox": { nl: "Terug naar Inbox", en: "Back to Inbox" },
  "inbox.chat.archive": { nl: "Archiveer", en: "Archive" },
  "inbox.chat.no_subject": { nl: "Geen onderwerp", en: "No subject" },
  "inbox.chat.no_preview": { nl: "Geen voorbeeld", en: "No preview" },
  "inbox.chat.mark_read": { nl: "Markeer gelezen", en: "Mark read" },
  "inbox.chat.mark_read_title": { nl: "Markeer geselecteerde gesprekken als gelezen", en: "Mark selected conversations as read" },
  "inbox.chat.mark_unread": { nl: "Markeer ongelezen", en: "Mark unread" },
  "inbox.chat.mark_unread_title": { nl: "Markeer geselecteerde gesprekken als ongelezen", en: "Mark selected conversations as unread" },
  "inbox.chat.clear_selection": { nl: "Selectie wissen", en: "Clear selection" },
  "inbox.chat.caught_up_title": { nl: "Je inbox is volledig up-to-date", en: "Your inbox is fully up to date" },
  "inbox.chat.caught_up_sub": { nl: "Alle tickets bijgewerkt. Lekker bezig.", en: "All tickets handled. Nice work." },
  "inbox.chat.select_conversation": { nl: "Selecteer een gesprek", en: "Select a conversation" },
  "inbox.chat.message": { nl: "bericht", en: "message" },
  "inbox.chat.messages": { nl: "berichten", en: "messages" },
  "inbox.chat.via": { nl: "via", en: "via" },
  "inbox.chat.no_messages": { nl: "Geen berichten in dit gesprek.", en: "No messages in this thread." },
  "inbox.chat.reply": { nl: "Antwoord", en: "Reply" },
  "inbox.chat.tab_internal": { nl: "Interne notitie", en: "Internal note" },
  "inbox.chat.internal_badge": { nl: "Intern", en: "Internal" },
  "inbox.chat.sent": { nl: "Verzonden", en: "Sent" },
  "inbox.chat.remove_attachment": { nl: "Bijlage verwijderen", en: "Remove attachment" },
  "inbox.chat.internal_title": { nl: "Alleen team - onzichtbaar voor de klant; @-vermeld om een teamlid te pingen", en: "Team-only note - invisible to the client; @-mention to ping a teammate" },
  "inbox.chat.composer_close": { nl: "Sluit composer", en: "Close composer" },
  "inbox.chat.connect_prefix": { nl: "Koppel eerst je ", en: "Connect your " },
  "inbox.chat.connect_suffix": { nl: "-account.", en: " account first." },
  "inbox.chat.go_to_account": { nl: "Ga naar Mijn account", en: "Go to My Account" },
  "inbox.chat.attach": { nl: "Bestanden bijvoegen", en: "Attach files" },
  "inbox.chat.send_email": { nl: "E-mail versturen", en: "Send email" },
  "inbox.chat.send_template": { nl: "Template versturen", en: "Send template" },
  "inbox.chat.internal_placeholder": { nl: "Interne notitie - alleen team. Gebruik @ om een teamlid te noemen.", en: "Internal note - team only. Use @ to mention a teammate." },
  "inbox.chat.reply_placeholder": { nl: "Antwoord via {source} als jezelf", en: "Reply via {source} as you" },
  "inbox.chat.send": { nl: "Versturen", en: "Send" },
  "inbox.chat.window_open": { nl: "Gespreksvenster open · sluit over {h}u", en: "Conversation window open · closes in {h}h" },
  "inbox.chat.window_closed": { nl: "Venster gesloten · alleen WhatsApp-templates kunnen worden verstuurd", en: "Window closed · only WhatsApp templates can be sent" },
  "inbox.chat.freetext_disabled": { nl: "Vrije tekst uitgeschakeld buiten het 24u-venster", en: "Free-text disabled outside the 24h window" },
  "inbox.chat.default_message": { nl: "Standaardbericht", en: "Default message" },
  "inbox.chat.default": { nl: "Standaard", en: "Default" },
  "inbox.chat.template": { nl: "Template", en: "Template" },
  "inbox.chat.template_send_title": { nl: "Verstuur een vooraf goedgekeurde WhatsApp Business-template", en: "Send a pre-approved WhatsApp Business template" },
  "inbox.chat.wa_template": { nl: "WhatsApp-template", en: "WhatsApp template" },
  "inbox.chat.loading_templates": { nl: "Templates laden…", en: "Loading templates…" },
  "inbox.chat.no_templates": { nl: "Geen goedgekeurde templates voor dit kanaal", en: "No approved templates for this channel" },
  "inbox.chat.templates_load_failed": { nl: "Templates laden mislukt: ", en: "Failed to load templates: " },
  "inbox.chat.select_template": { nl: "Selecteer een template…", en: "Select a template…" },
  "inbox.chat.variable": { nl: "Variabele {n}", en: "Variable {n}" },
  "inbox.chat.preview": { nl: "Voorbeeld", en: "Preview" },
  "inbox.chat.bold": { nl: "Vet (*x*)", en: "Bold (*x*)" },
  "inbox.chat.italic": { nl: "Cursief (_x_)", en: "Italic (_x_)" },
  "inbox.chat.strikethrough": { nl: "Doorhalen (~x~)", en: "Strikethrough (~x~)" },
  "inbox.chat.search_clients": { nl: "Klanten zoeken…", en: "Search clients…" },
  "inbox.chat.loading": { nl: "Laden…", en: "Loading…" },
  "inbox.chat.no_matches": { nl: "Geen resultaten", en: "No matches" },
  "inbox.chat.mention_unresolve_title": { nl: "Markeer notificatie als niet-afgehandeld", en: "Mark notification as unhandled" },
  "inbox.chat.mention_check_title": { nl: "Vink deze mention af", en: "Check off this mention" },
  "inbox.chat.mention_done_aria": { nl: "Mention afgehandeld - klik om terug te zetten", en: "Mention handled - click to undo" },
  "inbox.chat.make_task": { nl: "Taak maken van dit bericht", en: "Create task from this message" },
  "inbox.chat.pedro_draft_title": { nl: "Voeg Pedro's huidige concept-bericht toe aan het antwoord", en: "Add Pedro's current draft message to the reply" },
  "inbox.chat.pedro_draft": { nl: "Pedro concept", en: "Pedro draft" },
  "inbox.chat.mark_read_msg": { nl: "Markeer als gelezen", en: "Mark as read" },
  "inbox.chat.mark_unread_msg": { nl: "Markeer als ongelezen", en: "Mark as unread" },
  "inbox.chat.mention_unmatched": { nl: "Kon deze @-vermelding niet koppelen aan een teamlid. Typ de volledige naam of kies uit de suggesties.", en: "Couldn't match this @-mention to a teammate. Try typing the full name or pick from the suggestions." },
  "inbox.chat.mention_hint_pre": { nl: "Typ", en: "Type" },
  "inbox.chat.mention_hint_post": { nl: "om een teamlid te noemen. Zij krijgen een Update + pushnotificatie.", en: "to mention a teammate. They'll get an Update + push notification." },
  "inbox.chat.will_notify": { nl: "Notificeert", en: "Will notify" },
  "inbox.chat.unmatched_mention": { nl: "⚠ niet-herkende vermelding", en: "⚠ unmatched mention" },
  "inbox.chat.edit_contact": { nl: "Klik om contactnaam te bewerken", en: "Click to edit contact name" },
  "inbox.chat.channel_warning": { nl: "Geen {types}-kanaal/kanalen geabonneerd - daarom mis je ze in de inbox", en: "No {types} channel(s) subscribed - that's why you miss them in the inbox" },
  "inbox.chat.channel_missing_link": { nl: "Geen {types} channels - koppel ze in /account", en: "No {types} channels - connect them in /account" },
  "inbox.chat.trengo_not_connected_title": { nl: "Trengo niet gekoppeld", en: "Trengo not connected" },
  "inbox.chat.trengo_not_connected_body": { nl: "Je persoonlijke Trengo API token is niet ingesteld. Zonder dat kunnen Hub-sends niet als jou worden verstuurd.", en: "Your personal Trengo API token isn't set. Without it, Hub sends can't go out as you." },
  "inbox.chat.trengo_connect_cta": { nl: "Koppel Trengo in /account", en: "Connect Trengo in /account" },
  "inbox.chat.trengo_token_broken_title": { nl: "Trengo token werkt niet", en: "Trengo token isn't working" },
  "inbox.chat.trengo_refresh_cta": { nl: "Vernieuw je token in /account", en: "Refresh your token in /account" },
  ...
  // ─── Shared actions (billing / account / calendar) ────────────────────
  ...
  "common.connect": { nl: "Koppelen", en: "Connect" },
  "common.disconnect": { nl: "Ontkoppelen", en: "Disconnect" },
  "common.clear": { nl: "Wissen", en: "Clear" },
  "common.loading": { nl: "Laden…", en: "Loading…" },
  "common.add": { nl: "Toevoegen", en: "Add" },

  // ─── Billing page ─────────────────────────────────────────────────────
  "billing.title": { nl: "Facturatie", en: "Billing" },
  "billing.tabs.future": { nl: "Toekomstige facturen", en: "Future invoices" },
  "billing.tabs.past": { nl: "Verzonden facturen", en: "Past invoices" },

  // Refresh + sync buttons
  "billing.refresh.last_updated": { nl: "Laatst bijgewerkt {age}", en: "Last updated {age}" },
  "billing.refresh.just_now": { nl: "zojuist", en: "just now" },
  "billing.refresh.minutes_ago": { nl: "{minutes}m geleden", en: "{minutes}m ago" },
  "billing.refresh.hours_ago": { nl: "{hours}u geleden", en: "{hours}h ago" },
  "billing.refresh.days_ago": { nl: "{days}d geleden", en: "{days}d ago" },
  "billing.refresh.failed": { nl: "Verversen mislukt", en: "Refresh failed" },
  "billing.refresh.done": { nl: "Ververst · {parts}", en: "Refreshed · {parts}" },
  "billing.refresh.stripe_count": { nl: "{count} Stripe", en: "{count} Stripe" },
  "billing.refresh.drift_fixes": { nl: "{count} drift fix{plural}", en: "{count} drift fix{plural}" },
  "billing.refresh.title": { nl: "Verse data ophalen uit Monday + Stripe", en: "Pull fresh data from Monday + Stripe" },
  "billing.refresh.aria": { nl: "Facturatiedata verversen", en: "Refresh billing data" },
  "billing.sync.failed": { nl: "Sync mislukt", en: "Sync failed" },
  "billing.sync.done": { nl: "{count} klanten gesynct{failed}", en: "Synced {count} clients{failed}" },
  "billing.sync.failed_suffix": { nl: " ({count} mislukt)", en: " ({count} failed)" },
  "billing.sync.button": { nl: "Sync vanuit Monday", en: "Sync from Monday" },

  // Overview empty + summary
  "billing.overview.empty_title": { nl: "Geen toekomstige facturen gepland.", en: "No upcoming invoices scheduled." },
  "billing.overview.empty_hint": { nl: "Zet een volgende-factuurdatum op de Billing-tab van een klant om 'm hier te zien.", en: "Set a next-invoice date on a client's Billing tab to see it here." },
  "billing.overview.stat.scheduled": { nl: "Geplande klanten", en: "Scheduled clients" },
  "billing.overview.stat.due_this_week": { nl: "Deze week", en: "Due this week" },
  "billing.overview.stat.total_fee": { nl: "Totale fee", en: "Total fee" },
  "billing.overview.stat.total_fee_hint": { nl: "Som van service fees over geplande klanten", en: "Sum of service fees across scheduled clients" },
  "billing.overview.stat.outstanding": { nl: "Openstaand (Stripe)", en: "Outstanding (Stripe)" },
  "billing.overview.stat.outstanding_overdue": { nl: "{count} te laat", en: "{count} overdue" },
  "billing.overview.stat.outstanding_all": { nl: "Over alle geplande klanten", en: "Across all scheduled clients" },

  // Buckets
  "billing.bucket.needs_attention": { nl: "Aandacht nodig", en: "Needs attention" },
  "billing.bucket.needs_attention_hint": { nl: "Live klant · geen cycle-startdatum ingesteld", en: "Live client · no cycle start date set" },
  "billing.bucket.hold": { nl: "On hold", en: "On hold" },
  "billing.bucket.hold_hint": { nl: "Handmatig geparkeerd door finance", en: "Manually parked by finance" },
  "billing.bucket.overdue": { nl: "Te laat", en: "Overdue" },
  "billing.bucket.overdue_hint": { nl: "Voorbij hun volgende-factuurdatum", en: "Past their next-invoice date" },
  "billing.bucket.today": { nl: "Vandaag", en: "Today" },
  "billing.bucket.today_hint": { nl: "Vandaag versturen", en: "Send today" },
  "billing.bucket.this_week": { nl: "Deze week", en: "This week" },
  "billing.bucket.this_week_hint": { nl: "Tot en met zondag", en: "Through Sunday" },
  "billing.bucket.next_week": { nl: "Volgende week", en: "Next week" },
  "billing.bucket.next_week_hint": { nl: "Op de radar", en: "On the radar" },
  "billing.bucket.count_client": { nl: "{count} klant", en: "{count} client" },
  "billing.bucket.count_clients": { nl: "{count} klanten", en: "{count} clients" },

  // Overview table headers
  "billing.col.client": { nl: "Klant", en: "Client" },
  "billing.col.action": { nl: "Actie", en: "Action" },
  "billing.col.status": { nl: "Status", en: "Status" },
  "billing.col.admin": { nl: "Admin", en: "Admin" },
  "billing.col.am": { nl: "AM", en: "AM" },
  "billing.col.payment_date": { nl: "Betaaldatum", en: "Payment date" },
  "billing.col.invoice_out": { nl: "Factuur eruit", en: "Invoice out" },
  "billing.col.fee": { nl: "Fee", en: "Fee" },
  "billing.col.ad_budget": { nl: "Adbudget", en: "Ad budget" },
  "billing.col.payment_stripe": { nl: "Betaling (Stripe)", en: "Payment (Stripe)" },
  "billing.col.ai_check": { nl: "AI-check", en: "AI check" },
  "billing.col.stripe": { nl: "Stripe", en: "Stripe" },

  // Overview row
  "billing.row.expand_campaigns": { nl: "Campagnes uitklappen", en: "Expand campaigns" },
  "billing.row.collapse_campaigns": { nl: "Campagnes inklappen", en: "Collapse campaigns" },
  "billing.row.show_campaigns": { nl: "Campagnes tonen", en: "Show campaigns" },
  "billing.row.hide_campaigns": { nl: "Campagnes verbergen", en: "Hide campaigns" },
  "billing.row.campaigns_count": { nl: "{count} campagnes", en: "{count} campaigns" },
  "billing.row.create_invoice": { nl: "Factuur maken", en: "Create invoice" },
  "billing.row.create_invoice_multi": { nl: "Maak één Stripe-factuur voor alle {count} campagnes", en: "Create one Stripe invoice covering all {count} campaigns" },
  "billing.row.create_invoice_single": { nl: "Maak + verstuur een Stripe-factuur", en: "Create + send a Stripe invoice" },
  "billing.row.no_stripe_customer": { nl: "Geen Stripe-klant gekoppeld", en: "No Stripe customer linked" },
  "billing.row.set_payment_date": { nl: "Betaaldatum instellen", en: "Set payment date" },
  "billing.row.align_dates": { nl: "Datums uitlijnen", en: "Align dates" },
  "billing.row.align_dates_disabled": { nl: "Stel eerst een betaaldatum in", en: "Set a payment date first" },
  "billing.row.align_dates_title": { nl: "Pas deze betaaldatum toe op alle {count} campagnes van deze klant", en: "Apply this payment date to all {count} campaigns of this client" },
  "billing.row.stripe_open": { nl: "Openen", en: "Open" },
  "billing.row.no_stripe": { nl: "Geen Stripe", en: "No Stripe" },

  // Payment status pills
  "billing.payment.paid_up": { nl: "Betaald", en: "Paid up" },
  "billing.payment.overdue": { nl: "Te laat", en: "Overdue" },
  "billing.payment.open": { nl: "Open", en: "Open" },

  // Billing hold toggle
  "billing.hold.on_hold_reason": { nl: "On hold: {reason} - klik om vrij te geven", en: "On hold: {reason} - click to release" },
  "billing.hold.on_hold": { nl: "On hold - klik om vrij te geven", en: "On hold - click to release" },
  "billing.hold.hold_client": { nl: "Deze klant on hold zetten (deze cyclus niet factureren)", en: "Hold this client (skip invoicing this cycle)" },
  "billing.hold.release_aria": { nl: "Billing hold vrijgeven", en: "Release billing hold" },
  "billing.hold.hold_aria": { nl: "Deze klant on hold zetten", en: "Hold this client" },
  "billing.hold.update_failed": { nl: "Bijwerken van hold mislukt", en: "Failed to update hold" },

  // Admin edit cell
  "billing.admin.update_failed": { nl: "Bijwerken van adminstatus mislukt", en: "Failed to update admin status" },
  "billing.admin.monday_original": { nl: "Monday: {label}", en: "Monday: {label}" },

  // Agreement amount cell
  "billing.amount.click_to_edit": { nl: "Klik om te bewerken", en: "Click to edit" },
  "billing.amount.update_failed": { nl: "Bijwerken mislukt", en: "Update failed" },
  "billing.amount.non_negative": { nl: "Voer een niet-negatief getal in", en: "Enter a non-negative number" },

  // Next invoice date cell
  "billing.date.set_date": { nl: "Datum instellen", en: "Set date" },
  "billing.date.click_to_edit": { nl: "Klik om te bewerken", en: "Click to edit" },
  "billing.date.update_failed": { nl: "Bijwerken van datum mislukt", en: "Failed to update date" },

  // Invoice readiness cell
  "billing.readiness.send": { nl: "Versturen", en: "Send" },
  "billing.readiness.check": { nl: "Checken", en: "Check" },
  "billing.readiness.hold": { nl: "Hold", en: "Hold" },
  "billing.readiness.ai_failed": { nl: "AI mislukt", en: "AI failed" },
  "billing.readiness.run_check": { nl: "AI-check draaien", en: "Run AI check" },
  "billing.readiness.error_retry": { nl: "AI-check mislukt - open om opnieuw te proberen", en: "AI check failed - open to retry" },
  "billing.readiness.confidence": { nl: "{label} · {pct}% vertrouwen", en: "{label} · {pct}% confidence" },
  "billing.readiness.rerun": { nl: "AI-check opnieuw draaien", en: "Re-run AI check" },
  "billing.readiness.reason": { nl: "Reden", en: "Reason" },
  "billing.readiness.monday_updates": { nl: "Monday-updates ({count})", en: "Monday updates ({count})" },
  "billing.readiness.open_in_monday": { nl: "Openen in Monday", en: "Open in Monday" },
  "billing.readiness.no_updates": { nl: "Geen updates in de afgelopen 21 dagen.", en: "No updates in the last 21 days." },

  // Past invoices view
  "billing.past.filter.all": { nl: "Alle", en: "All" },
  "billing.past.filter.open": { nl: "Open", en: "Open" },
  "billing.past.filter.overdue": { nl: "Te laat", en: "Overdue" },
  "billing.past.filter.paid": { nl: "Betaald", en: "Paid" },
  "billing.past.filter.void": { nl: "Vervallen", en: "Void" },
  "billing.past.status.paid": { nl: "Betaald", en: "Paid" },
  "billing.past.status.open": { nl: "Open", en: "Open" },
  "billing.past.status.overdue": { nl: "Te laat", en: "Overdue" },
  "billing.past.status.draft": { nl: "Concept", en: "Draft" },
  "billing.past.status.void": { nl: "Vervallen", en: "Void" },
  "billing.past.stat.invoices_in_view": { nl: "Facturen in beeld", en: "Invoices in view" },
  "billing.past.stat.total_invoiced": { nl: "Totaal gefactureerd", en: "Total invoiced" },
  "billing.past.stat.outstanding": { nl: "Openstaand", en: "Outstanding" },
  "billing.past.stat.outstanding_overdue": { nl: "{count} te laat", en: "{count} overdue" },
  "billing.past.stat.paid": { nl: "Betaald", en: "Paid" },
  "billing.past.empty_not_loaded_title": { nl: "Verzonden facturen zijn nog niet geladen.", en: "Past invoices haven't been loaded yet." },
  "billing.past.empty_not_loaded_hint_pre": { nl: "Klik op ", en: "Hit " },
  "billing.past.empty_not_loaded_hint_refresh": { nl: "Verversen", en: "Refresh" },
  "billing.past.empty_not_loaded_hint_post": { nl: " bovenaan om ze uit Stripe te halen - draait anders elk uur.", en: " at the top to pull them from Stripe - runs hourly otherwise." },
  "billing.past.empty_no_match": { nl: "Geen facturen die aan deze filters voldoen.", en: "No invoices match these filters." },
  "billing.past.col.number": { nl: "Nummer", en: "Number" },
  "billing.past.col.client": { nl: "Klant", en: "Client" },
  "billing.past.col.date": { nl: "Datum", en: "Date" },
  "billing.past.col.amount": { nl: "Bedrag", en: "Amount" },
  "billing.past.col.status": { nl: "Status", en: "Status" },
  "billing.past.col.link": { nl: "Link", en: "Link" },
  "billing.past.unknown_customer": { nl: "Onbekend · {id}…", en: "Unknown · {id}…" },
  "billing.past.copy_link": { nl: "Factuurlink kopiëren", en: "Copy invoice link" },
  "billing.past.copied": { nl: "Gekopieerd", en: "Copied" },
  "billing.past.copy_link_label": { nl: "Kopieer link", en: "Copy link" },
  "billing.past.open_invoice_page": { nl: "Factuurpagina openen", en: "Open invoice page" },

  // Global create invoice
  "billing.global.new_invoice": { nl: "Nieuwe factuur", en: "New invoice" },
  "billing.global.pick_client_title": { nl: "Nieuwe factuur - kies een klant", en: "New invoice - pick a client" },
  "billing.global.search_placeholder": { nl: "Klanten zoeken…", en: "Search clients…" },
  "billing.global.clear_search": { nl: "Zoekopdracht wissen", en: "Clear search" },
  "billing.global.search_failed": { nl: "Klantzoekopdracht mislukt", en: "Client search failed" },
  "billing.global.load_failed": { nl: "Laden van klant mislukt", en: "Failed to load client" },
  "billing.global.no_stripe_customer": { nl: "{name} heeft geen Stripe-klant gekoppeld. Koppel er eerst een op de Billing-tab van de klant.", en: "{name} has no Stripe customer linked. Link one on the client's Billing tab first." },
  "billing.global.loading_clients": { nl: "Klanten laden…", en: "Loading clients…" },
  "billing.global.no_match": { nl: "Geen klanten gevonden.", en: "No clients match." },

  // Create invoice dialog
  "billing.invoice.review_title": { nl: "Factuur controleren - {name}", en: "Review invoice - {name}" },
  "billing.invoice.sent_title": { nl: "Factuur verzonden - {name}", en: "Invoice sent - {name}" },
  "billing.invoice.create_title": { nl: "Factuur maken - {name}", en: "Create invoice - {name}" },
  "billing.invoice.sent_to_customer": { nl: "Factuur {number} naar de klant verstuurd.", en: "Invoice {number} sent to the customer." },
  "billing.invoice.draft": { nl: "concept", en: "draft" },
  "billing.invoice.oneoff_cycle_unchanged": { nl: "Eenmalige charge - de betaalcyclus is ongewijzigd gebleven.", en: "One-off charge - the payment cycle was left unchanged." },
  "billing.invoice.next_payment_set": { nl: "Volgende betaaldatum ingesteld op {date}. Je kunt 'm nog aanpassen op de Billing-pagina.", en: "Next payment date set to {date}. You can still adjust it on the Billing page." },
  "billing.invoice.monday_not_synced": { nl: "Stripe-verzending is gelukt, maar Monday synchroniseerde niet volledig:", en: "Stripe send went through, but Monday didn't fully sync:" },
  "billing.invoice.view_in_stripe": { nl: "Bekijk in Stripe", en: "View in Stripe" },
  "billing.invoice.recipient": { nl: "Ontvanger", en: "Recipient" },
  "billing.invoice.company_name": { nl: "Bedrijfsnaam", en: "Company name" },
  "billing.invoice.email": { nl: "E-mail", en: "Email" },
  "billing.invoice.address_line1": { nl: "Adresregel 1", en: "Address line 1" },
  "billing.invoice.address_line2": { nl: "Adresregel 2", en: "Address line 2" },
  "billing.invoice.postal_code": { nl: "Postcode", en: "Postal code" },
  "billing.invoice.city": { nl: "Plaats", en: "City" },
  "billing.invoice.country": { nl: "Land", en: "Country" },
  "billing.invoice.vat_number": { nl: "VAT / BTW-nummer", en: "VAT / BTW number" },
  "billing.invoice.save_to_stripe": { nl: "Opslaan naar Stripe", en: "Save to Stripe" },
  "billing.invoice.update_recipient_failed": { nl: "Bijwerken van ontvanger mislukt", en: "Failed to update recipient" },
  "billing.invoice.no_name": { nl: "(geen naam)", en: "(no name)" },
  "billing.invoice.no_tax_id": { nl: "Geen tax-ID bekend - Stripe rekent 20% BG VAT.", en: "No tax ID on file - Stripe will charge 20% BG VAT." },
  "billing.invoice.line_items": { nl: "Factuurregels", en: "Line items" },
  "billing.invoice.subtotal_excl_btw": { nl: "Subtotaal (excl. BTW)", en: "Subtotal (excl. BTW)" },
  "billing.invoice.btw_rate": { nl: "BTW ({rate})", en: "BTW ({rate})" },
  "billing.invoice.total": { nl: "Totaal", en: "Total" },
  "billing.invoice.reverse_charge": { nl: "Reverse charge - klant heeft een geldig BTW-nummer, geen BTW gerekend.", en: "Reverse charge - client has a valid VAT number, no BTW charged." },
  "billing.invoice.btw_20": { nl: "20% BG VAT - Stripe rekent dit automatisch op de factuur (geen losse regel, wel zichtbaar als BTW-totaal).", en: "20% BG VAT - Stripe charges this automatically on the invoice (no separate line, but visible as the BTW total)." },
  "billing.invoice.btw_mismatch": { nl: "Preview-mismatch: Stripe past 20% BG VAT toe op send. Controleer de definitieve factuur na verzenden.", en: "Preview mismatch: Stripe applies 20% BG VAT on send. Check the final invoice after sending." },
  "billing.invoice.due_in_days": { nl: "Betaaltermijn {count} dag{plural} vanaf vandaag.", en: "Due in {count} day{plural} from today." },
  "billing.invoice.back_to_edit": { nl: "Terug naar bewerken", en: "Back to edit" },
  "billing.invoice.confirm_send": { nl: "Bevestig & verstuur", en: "Confirm & send" },
  "billing.invoice.mode_monthly": { nl: "Maandelijkse factuur", en: "Monthly invoice" },
  "billing.invoice.mode_oneoff": { nl: "Eenmalige factuur", en: "One-off invoice" },
  "billing.invoice.stripe_customer": { nl: "Stripe-klant:", en: "Stripe customer:" },
  "billing.invoice.mode_monthly_hint": { nl: "Terugkerende factuur. Markeert de klant als gefactureerd; Monday schuift de betaaldatum op.", en: "Recurring invoice. Marks the client as invoiced; Monday advances the payment date." },
  "billing.invoice.mode_oneoff_hint": { nl: "Eenmalige charge - verandert de betaalcyclus, MRR of adminstatus niet.", en: "One-off charge - won't change the payment cycle, MRR or admin status." },
  "billing.invoice.description": { nl: "Omschrijving", en: "Description" },
  "billing.invoice.description_placeholder": { nl: "Omschrijving", en: "Description" },
  "billing.invoice.add_line": { nl: "Regel toevoegen", en: "Add line" },
  "billing.invoice.add_discount": { nl: "Korting toevoegen", en: "Add discount" },
  "billing.invoice.discount_label": { nl: "Korting", en: "Discount" },
  "billing.invoice.prorata": { nl: "Pro-rata", en: "Pro-rata" },
  "billing.invoice.prorated_charge": { nl: "Pro-rata charge", en: "Prorated charge" },
  "billing.invoice.prorata_set_date_first": { nl: "Stel eerst een betaaldatum in om tegen te proraten.", en: "Set a payment date first to prorate against it." },
  "billing.invoice.package_monthly_price": { nl: "Maandprijs pakket", en: "Package monthly price" },
  "billing.invoice.prorata_desc_placeholder": { nl: "bijv. Google Ads", en: "e.g. Google Ads" },
  "billing.invoice.prorata_preview": { nl: "{remaining} van {total} dagen → {amount} tot {date}", en: "{remaining} of {total} days → {amount} until {date}" },
  "billing.invoice.prorata_past": { nl: "Betaaldatum is vandaag of voorbij - geen deelperiode om te proraten. Voeg het volledige bedrag toe als normale regel.", en: "Payment date is today or past - no partial period to prorate. Add the full amount as a normal line instead." },
  "billing.invoice.package_default": { nl: "Pakket", en: "Package" },
  "billing.invoice.prorata_line_desc": { nl: "Pro-rata: {label} ({from} – {to})", en: "Pro-rata: {label} ({from} – {to})" },
  "billing.invoice.next_payment_date": { nl: "Factuurperiode t/m", en: "Billing period until" },
  "billing.invoice.next_payment_after": { nl: "periode start · nu {date}", en: "period starts · currently {date}" },
  "billing.invoice.next_payment_hint": { nl: "Bepaalt alleen de periode op de factuurregels (bijv. \"1 sep – 30 sep\"). Standaard +1 maand; zet +2 of +3 voor kwartaalklanten. De betaaldatum zelf wordt door Monday opgeschoven, niet door de Hub.", en: "Only sets the period shown on the invoice lines (e.g. \"1 Sep – 30 Sep\"). Defaults to +1 month; set +2 or +3 for quarterly clients. The payment date itself is advanced by Monday, not the Hub." },
  "billing.invoice.due_in_days_label": { nl: "Betaaltermijn (dagen)", en: "Due in (days)" },
  "billing.invoice.subtotal": { nl: "Subtotaal", en: "Subtotal" },
  "billing.invoice.preview": { nl: "Preview", en: "Preview" },
  "billing.invoice.remove_line": { nl: "Regel verwijderen", en: "Remove line" },
  "billing.invoice.remove_line_n": { nl: "Regel {n} verwijderen", en: "Remove line {n}" },
  "billing.invoice.at_least_one_required": { nl: "Minimaal één factuurregel is verplicht", en: "At least one line item is required" },
  "billing.invoice.err_at_least_one": { nl: "Voeg minstens één factuurregel toe met omschrijving en bedrag.", en: "Add at least one line item with a description and amount." },
  "billing.invoice.err_due_range": { nl: "Betaaltermijn moet tussen 0 en 90 dagen vanaf vandaag liggen.", en: "Due date must be between 0 and 90 days from today." },
  "billing.invoice.err_preview_failed": { nl: "Bouwen van factuur-preview mislukt", en: "Failed to build invoice preview" },
  "billing.invoice.err_next_payment": { nl: "Voer een geldige volgende betaaldatum in (of laat 'm leeg om de cyclus ongewijzigd te laten).", en: "Enter a valid next payment date (or clear it to leave the cycle unchanged)." },
  "billing.invoice.err_send_failed": { nl: "Versturen van factuur mislukt", en: "Failed to send invoice" },

  // Invoice action menu
  "billing.action.this_invoice": { nl: "deze factuur", en: "this invoice" },
  "billing.action.aria": { nl: "Factuuracties", en: "Invoice actions" },
  "billing.action.resend_reminder": { nl: "Herinnering opnieuw sturen", en: "Resend reminder" },
  "billing.action.mark_paid_bank": { nl: "Markeer als betaald (bankoverschrijving)", en: "Mark paid (bank transfer)" },
  "billing.action.credit_note_dots": { nl: "Creditnota…", en: "Credit note…" },
  "billing.action.void_invoice": { nl: "Factuur vervallen verklaren", en: "Void invoice" },
  "billing.action.mark_uncollectible": { nl: "Markeer als oninbaar", en: "Mark uncollectible" },
  "billing.action.credit_note_refund_dots": { nl: "Creditnota / terugbetaling…", en: "Credit note / refund…" },
  "billing.action.reason.order_change": { nl: "Orderwijziging", en: "Order change" },
  "billing.action.reason.product_unsatisfactory": { nl: "Product niet naar wens", en: "Product unsatisfactory" },
  "billing.action.reason.duplicate": { nl: "Duplicaat", en: "Duplicate" },
  "billing.action.reason.fraudulent": { nl: "Frauduleus", en: "Fraudulent" },
  "billing.action.title.resend": { nl: "Herinnering opnieuw sturen – {label}", en: "Resend reminder – {label}" },
  "billing.action.title.pay_offline": { nl: "Markeer als betaald – {label}", en: "Mark paid – {label}" },
  "billing.action.title.void": { nl: "Factuur vervallen verklaren – {label}", en: "Void invoice – {label}" },
  "billing.action.title.uncollectible": { nl: "Markeer als oninbaar – {label}", en: "Mark uncollectible – {label}" },
  "billing.action.title.credit_note": { nl: "Creditnota – {label}", en: "Credit note – {label}" },
  "billing.action.desc.resend": { nl: "Stuur de factuur-e-mail opnieuw naar de klant als betaalherinnering. Er verandert niets aan de bedragen.", en: "Re-send the invoice email to the customer as a payment reminder. No amounts change." },
  "billing.action.desc.pay_offline_pre": { nl: "Boek deze factuur als betaald buiten Stripe (bijv. bankoverschrijving). Stripe markeert 'm als betaald, dus de betaalstatus springt naar ", en: "Record this invoice as paid outside Stripe (e.g. bank transfer). Stripe marks it paid, so the payment status flips to " },
  "billing.action.desc.pay_offline_post": { nl: ". Doe dit pas als het geld ook echt binnen is.", en: ". Only do this once the money has actually landed." },
  "billing.action.desc.void_1": { nl: "Vervallen verklaren annuleert de factuur – de klant is niets verschuldigd en 'm heropenen kan niet. Gebruik dit voor een per ongeluk verstuurde factuur.", en: "Voiding cancels the invoice – the customer owes nothing and it can't be reopened. Use this for an invoice sent in error." },
  "billing.action.desc.void_warning": { nl: "Dit kan niet ongedaan gemaakt worden.", en: "This cannot be undone." },
  "billing.action.desc.uncollectible": { nl: "Markeer deze factuur als oninbaar (afgeschreven oninbare vordering). Blijft op de boeken staan maar telt niet meer mee als verwachte inkomsten.", en: "Mark this invoice as uncollectible (written-off bad debt). It stays on the books but stops counting as expected income." },
  "billing.action.desc.credit_note_paid": { nl: "Maak een creditnota aan tegen deze betaalde factuur. Betaal het geld terug aan de klant, of crediteer hun Stripe-saldo voor de volgende keer.", en: "Issue a credit note against this paid invoice. Refund the money to the customer, or credit their Stripe balance for next time." },
  "billing.action.desc.credit_note_open": { nl: "Maak een creditnota aan om te verlagen wat de klant op deze factuur verschuldigd is.", en: "Issue a credit note to reduce what the customer owes on this invoice." },
  "billing.action.credit_amount": { nl: "Creditbedrag", en: "Credit amount" },
  "billing.action.reason_label": { nl: "Reden", en: "Reason" },
  "billing.action.refund_checkbox": { nl: "Betaal het geld terug aan de klant (anders crediteer hun Stripe-saldo)", en: "Refund the money to the customer (otherwise credit their Stripe balance)" },
  "billing.action.invoice_total": { nl: "Factuurtotaal: {amount}", en: "Invoice total: {amount}" },
  "billing.action.err_credit_amount": { nl: "Voer een creditbedrag groter dan 0 in.", en: "Enter a credit amount greater than 0." },
  "billing.action.err_action_failed": { nl: "Actie mislukt", en: "Action failed" },
  "billing.action.btn.resend": { nl: "Opnieuw sturen", en: "Resend" },
  "billing.action.btn.pay_offline": { nl: "Markeer als betaald", en: "Mark paid" },
  "billing.action.btn.void": { nl: "Factuur vervallen verklaren", en: "Void invoice" },
  "billing.action.btn.uncollectible": { nl: "Markeer als oninbaar", en: "Mark uncollectible" },
  "billing.action.btn.credit_note": { nl: "Creditnota aanmaken", en: "Issue credit note" },

  // ─── Account / Me tab ─────────────────────────────────────────────────
  "account.signed_in_as": { nl: "Ingelogd als", en: "Signed in as" },
  "account.platform_connections": { nl: "Platformkoppelingen", en: "Platform connections" },
  "account.browser_notifications": { nl: "Browsermeldingen", en: "Browser notifications" },
  "account.inbox_subscriptions": { nl: "Inbox-abonnementen", en: "Inbox subscriptions" },

  // Avatar editor
  "account.avatar.change_photo": { nl: "Foto wijzigen", en: "Change photo" },
  "account.avatar.upload_photo": { nl: "Foto uploaden", en: "Upload photo" },
  "account.avatar.hint": { nl: "PNG, JPEG of WebP. Wordt getoond naast je updates, taken en berichten.", en: "PNG, JPEG or WebP. Shown next to your updates, tasks and messages." },
  "account.avatar.upload_failed": { nl: "Uploaden mislukt", en: "Upload failed" },
  "account.avatar.read_failed": { nl: "Kon die afbeelding niet lezen", en: "Couldn't read that image" },
  "account.avatar.remove_failed": { nl: "Verwijderen mislukt", en: "Remove failed" },

  // Google Calendar card
  "account.gcal.connect_different": { nl: "Andere Google Calendar koppelen", en: "Connect different Google Calendar" },
  "account.gcal.desc_signin": { nl: "Je Calendar-pagina leest uit hetzelfde Google-account waarmee je bent ingelogd. Gebruik een ander Google-account als je werkagenda ergens anders staat (bijv. een gedeeld teamaccount).", en: "Your Calendar page reads from the same Google account you signed in with. Use a different Google account if your work calendar lives elsewhere (e.g. a shared team account)." },
  "account.gcal.desc_other": { nl: "Je Calendar-pagina leest uit dit account in plaats van het account waarmee je bent ingelogd. Je kunt altijd terugschakelen.", en: "Your Calendar page reads from this account instead of the one you signed in with. Switch back any time." },
  "account.gcal.currently_using": { nl: "Momenteel actief", en: "Currently using" },
  "account.gcal.signin_account": { nl: "Login-account", en: "Sign-in account" },
  "account.gcal.different_account": { nl: "Ander account", en: "Different account" },
  "account.gcal.switched_to": { nl: "Overgeschakeld naar", en: "Switched to" },
  "account.gcal.switch": { nl: "Wissel naar een ander Google Calendar-account", en: "Switch to a different Google Calendar account" },
  "account.gcal.connect": { nl: "Een Google Calendar-account koppelen", en: "Connect a Google Calendar account" },
  "account.gcal.use_signin": { nl: "Gebruik in plaats daarvan mijn login-account", en: "Use my sign-in account instead" },
  "account.gcal.disconnect_failed": { nl: "Ontkoppelen mislukt", en: "Failed to disconnect" },
  "account.gcal.connect_failed": { nl: "Google Calendar-koppeling mislukt ({code}).", en: "Google Calendar connect failed ({code})." },
  "account.gcal.err.oauth_not_configured": { nl: "Google OAuth is nog niet geconfigureerd voor deze deployment.", en: "Google OAuth isn't configured for this deployment yet." },
  "account.gcal.err.access_denied": { nl: "Je hebt de Google-autorisatie geannuleerd.", en: "You cancelled the Google authorization." },
  "account.gcal.err.missing_code_or_state": { nl: "Google kwam terug zonder code. Probeer opnieuw te koppelen.", en: "Google returned without a code. Try connecting again." },
  "account.gcal.err.missing_state_cookie": { nl: "Je browser blokkeerde de OAuth state-cookie. Probeer het opnieuw in een niet-incognito venster.", en: "Your browser blocked the OAuth state cookie. Try again in a non-incognito window." },
  "account.gcal.err.state_mismatch": { nl: "OAuth state-mismatch — mogelijk CSRF of verlopen flow. Probeer opnieuw.", en: "OAuth state mismatch — possible CSRF or expired flow. Try again." },
  "account.gcal.err.session_mismatch": { nl: "Je login-sessie veranderde tijdens de OAuth-flow. Log opnieuw in en probeer het nog eens.", en: "Your sign-in session changed during the OAuth flow. Sign in again, then retry." },
  "account.gcal.err.exchange_failed": { nl: "Google weigerde de OAuth code-exchange. Probeer opnieuw.", en: "Google rejected the OAuth code exchange. Try again." },
  "account.gcal.err.no_refresh_token": { nl: "Google gaf geen refresh token terug. Log eerst uit bij google.com en probeer het opnieuw.", en: "Google didn't return a refresh token. Sign out of the account at google.com first and try again." },
  "account.gcal.err.userinfo_failed": { nl: "Gekoppeld, maar Google gaf het gekozen e-mailadres niet terug — probeer opnieuw.", en: "Connected but Google didn't return the picked email — try again." },
  "account.gcal.err.store_failed": { nl: "Kon de agenda-tokens niet opslaan. Probeer opnieuw of neem contact op met een admin.", en: "Couldn't save the calendar tokens. Try again or contact an admin." },
  "account.gcal.err.oauth_failed": { nl: "Google meldde een OAuth-fout. Probeer opnieuw.", en: "Google reported an OAuth failure. Try again." },

  // Slack card
  "account.slack.desc": { nl: "Koppel via OAuth zodat antwoorden in Slack als jou worden gepost, in het juiste kanaal of DM.", en: "Connect via OAuth so replies post in Slack as you, in the right channel or DM." },
  "account.slack.connect": { nl: "Slack koppelen", en: "Connect Slack" },
  "account.slack.disconnect_failed": { nl: "Ontkoppelen mislukt", en: "Failed to disconnect" },
  "account.slack.connect_failed": { nl: "Slack-koppeling mislukt ({code}).", en: "Slack connect failed ({code})." },
  "account.slack.err.oauth_not_configured": { nl: "Slack OAuth is nog niet ingesteld op deze deployment. Een admin moet een Slack-app maken en SLACK_CLIENT_ID, SLACK_CLIENT_SECRET en SLACK_SIGNING_SECRET aan de omgeving toevoegen.", en: "Slack OAuth isn't set up on this deployment yet. An admin needs to create a Slack app and add SLACK_CLIENT_ID, SLACK_CLIENT_SECRET and SLACK_SIGNING_SECRET to the environment." },
  "account.slack.err.start_failed": { nl: "Kon de Slack-koppelflow niet starten. Probeer het opnieuw of neem contact op met een admin.", en: "Couldn't start the Slack connect flow. Please try again or contact an admin." },
  "account.slack.err.missing_code_or_state": { nl: "Slack kwam terug zonder code. Probeer opnieuw te koppelen.", en: "Slack returned without a code. Try connecting again." },
  "account.slack.err.missing_state_cookie": { nl: "Je browser blokkeerde de OAuth state-cookie. Probeer het opnieuw in een niet-incognito venster.", en: "Your browser blocked the OAuth state cookie. Try again in a non-incognito window." },
  "account.slack.err.state_mismatch": { nl: "OAuth state-mismatch - mogelijk CSRF of verlopen flow. Probeer opnieuw.", en: "OAuth state mismatch - possible CSRF or expired flow. Try again." },
  "account.slack.err.exchange_failed": { nl: "Slack weigerde de OAuth code-exchange. Probeer opnieuw.", en: "Slack rejected the OAuth code exchange. Try again." },
  "account.slack.err.oauth_failed": { nl: "Slack meldde een OAuth-fout. Probeer opnieuw.", en: "Slack reported an OAuth failure. Try again." },
  "account.slack.err.store_failed": { nl: "Kon je Slack-token niet opslaan. Probeer opnieuw of neem contact op met een admin.", en: "Couldn't save your Slack token. Try again or contact an admin." },
  "account.slack.err.access_denied": { nl: "Je hebt de Slack-autorisatie geannuleerd.", en: "You cancelled the Slack authorization." },

  // Trengo / Monday token cards
  "account.trengo.desc": { nl: "Plak je persoonlijke Trengo API-token. Vind 'm in Trengo → Settings → Integrations.", en: "Paste your personal Trengo API token. Find it in Trengo → Settings → Integrations." },
  "account.trengo.placeholder": { nl: "Trengo persoonlijk access token", en: "Trengo personal access token" },
  "account.monday.desc": { nl: "Plak je persoonlijke Monday API-token. Vind 'm in Monday → avatar (rechtsboven) → Developers → Personal API token.", en: "Paste your personal Monday API token. Find it in Monday → avatar (top-right) → Developers → Personal API token." },
  "account.monday.placeholder": { nl: "Monday persoonlijk API-token", en: "Monday personal API token" },
  "account.token.where_to_find": { nl: "Waar vind je je token", en: "Where to find your token" },
  "account.token.connect_failed": { nl: "Koppelen mislukt", en: "Failed to connect" },
  "account.token.disconnect_failed": { nl: "Ontkoppelen mislukt", en: "Failed to disconnect" },

  // Platform card shell
  "account.card.connected": { nl: "Gekoppeld", en: "Connected" },
  "account.card.not_connected": { nl: "Niet gekoppeld", en: "Not connected" },

  // Trengo channels card
  "account.channels.title": { nl: "Trengo-kanalen", en: "Trengo channels" },
  "account.channels.saving": { nl: "Opslaan…", en: "Saving…" },
  "account.channels.saved": { nl: "Opgeslagen", en: "Saved" },
  "account.channels.selected": { nl: "{count} geselecteerd", en: "{count} selected" },
  "account.channels.desc": { nl: "Tickets uit geselecteerde kanalen verschijnen in je Client Inbox, ook als het contact niet aan een klant gekoppeld is.", en: "Tickets from selected channels appear in your Client Inbox even when the contact isn't linked to a client." },
  "account.channels.load_failed": { nl: "Laden van kanalen mislukt", en: "Failed to load channels" },
  "account.channels.loading": { nl: "Kanalen laden…", en: "Loading channels…" },
  "account.channels.select_all": { nl: "Alles selecteren", en: "Select all" },
  "account.channels.clear": { nl: "Wissen", en: "Clear" },
  "account.channels.none_found": { nl: "Geen kanalen gevonden in deze Trengo-workspace.", en: "No channels found in this Trengo workspace." },
  "account.channels.save_failed": { nl: "Opslaan mislukt", en: "Failed to save" },
  "account.channels.silent_title": { nl: "Geabonneerd maar geen events ontvangen in de afgelopen 7 dagen - webhook levert mogelijk niet voor dit kanaal", en: "Subscribed but no events ingested in the last 7 days - webhook may not be delivering for this channel" },
  "account.channels.events_title": { nl: "{count} events ontvangen in de afgelopen 7 dagen", en: "{count} events ingested in last 7 days" },

  // Browser notifications card
  "account.notif.push_not_configured": { nl: "Server-side push is nog niet geconfigureerd (VAPID keys ontbreken).", en: "Server-side push isn't configured yet (VAPID keys missing)." },
  "account.notif.save_failed": { nl: "Server kon de subscription niet opslaan.", en: "Server couldn't save the subscription." },
  "account.notif.enable_failed": { nl: "Kon notificaties niet inschakelen.", en: "Couldn't enable notifications." },
  "account.notif.disable_failed": { nl: "Kon notificaties niet uitschakelen.", en: "Couldn't disable notifications." },
  "account.notif.loading": { nl: "Laden…", en: "Loading…" },
  "account.notif.unsupported": { nl: "Deze browser ondersteunt geen push-notificaties (Safari op iOS pas vanaf 16.4).", en: "This browser doesn't support push notifications (Safari on iOS only from 16.4)." },
  "account.notif.on_title": { nl: "Notificaties staan aan", en: "Notifications are on" },
  "account.notif.off_title": { nl: "Notificaties zijn uit", en: "Notifications are off" },
  "account.notif.active": { nl: "Actief", en: "Active" },
  "account.notif.blocked": { nl: "Geblokkeerd door browser", en: "Blocked by browser" },
  "account.notif.off": { nl: "Uit", en: "Off" },
  "account.notif.desc_on": { nl: "Je krijgt nu desktop/mobiele meldingen voor nieuwe taken. Werkt op deze browser; herhaal op andere apparaten als je daar ook gepingd wilt worden.", en: "You now get desktop/mobile notifications for new tasks. Works on this browser; repeat on other devices if you want to be pinged there too." },
  "account.notif.desc_denied": { nl: "Je hebt eerder de toestemming geweigerd. Open je browser-instellingen en sta meldingen toe voor deze site om opnieuw te proberen.", en: "You denied permission earlier. Open your browser settings and allow notifications for this site to try again." },
  "account.notif.desc_default": { nl: "Eén klik om aan te zetten - je browser vraagt toestemming.", en: "One click to turn on - your browser asks for permission." },
  "account.notif.disable": { nl: "Uitschakelen", en: "Disable" },
  "account.notif.send_test": { nl: "Stuur test", en: "Send test" },
  "account.notif.enable": { nl: "Inschakelen", en: "Enable" },
  "account.notif.test_failed": { nl: "Test mislukt", en: "Test failed" },

  // ─── Calendar page ────────────────────────────────────────────────────
  "calendar.tab.calendar": { nl: "Kalender", en: "Calendar" },
  "calendar.tab.recordings": { nl: "Opnames", en: "Recordings" },
  "calendar.today": { nl: "Vandaag", en: "Today" },
  "calendar.prev": { nl: "Vorige {view}", en: "Previous {view}" },
  "calendar.next": { nl: "Volgende {view}", en: "Next {view}" },
  "calendar.new_event": { nl: "Nieuw event", en: "New event" },
  "calendar.connect_to_create": { nl: "Koppel Google Calendar om events aan te maken", en: "Connect Google Calendar to create events" },
  "calendar.load_failed": { nl: "Laden van agenda mislukt", en: "Failed to load calendar" },
  "calendar.load_failed_retry": { nl: "Kon de agenda niet laden. Probeer te verversen.", en: "Couldn't load calendar. Try refreshing." },
  "calendar.view.day": { nl: "Dag", en: "Day" },
  "calendar.view.week": { nl: "Week", en: "Week" },
  "calendar.view.month": { nl: "Maand", en: "Month" },
  "calendar.panel.today": { nl: "Vandaag", en: "Today" },
  "calendar.panel.event": { nl: "event", en: "event" },
  "calendar.panel.events": { nl: "events", en: "events" },
  "calendar.panel.nothing_today": { nl: "Niets gepland vandaag.", en: "Nothing scheduled today." },
  "calendar.panel.all_day": { nl: "Hele dag", en: "All-day" },
  "calendar.panel.type.meeting": { nl: "meeting", en: "meeting" },
  "calendar.panel.type.task": { nl: "taak", en: "task" },
  "calendar.sources": { nl: "Bronnen", en: "Sources" },
  "calendar.sources.google_sync": { nl: "Google-sync", en: "Google sync" },
  "calendar.sources.meetings": { nl: "Meetings", en: "Meetings" },
  "calendar.sources.google_cal": { nl: "Google Cal", en: "Google Cal" },
  "calendar.sources.not_linked": { nl: "niet gekoppeld", en: "not linked" },
  "calendar.sources.tasks": { nl: "Taken", en: "Tasks" },
  "calendar.sources.hub": { nl: "Hub", en: "Hub" },
  "calendar.sources.toggle_hint": { nl: "Een bron uitschakelen verbergt zijn events uit het rooster.", en: "Toggling a source hides its events from the grid." },
  "calendar.undated.text": { nl: "Je hebt {label}. Voeg een deadline toe in de Inbox en ze verschijnen hier.", en: "You have {label}. Add a due date in the Inbox and they'll show up here." },
  "calendar.undated.task_singular": { nl: "{count} taak zonder deadline", en: "{count} task without a due date" },
  "calendar.undated.task_plural": { nl: "{count} taken zonder deadline", en: "{count} tasks without a due date" },
  "calendar.open_inbox": { nl: "Inbox openen", en: "Open Inbox" },
  "calendar.error.title": { nl: "Google Calendar fout", en: "Google Calendar error" },
  "calendar.connect.title": { nl: "Google Calendar is niet gekoppeld", en: "Google Calendar is not connected" },
  "calendar.connect.body": { nl: "Log uit en weer in om agenda-toegang te verlenen. Hub-taken hieronder blijven zichtbaar. ", en: "Sign out and sign back in to grant calendar access. Hub tasks below will still show. " },
  "calendar.connect.resign": { nl: "Opnieuw inloggen", en: "Re-sign-in" },
  "calendar.month.more": { nl: "+ {count} meer", en: "+ {count} more" },
  "calendar.selector.hide_meetings": { nl: "Meetings verbergen", en: "Hide meetings" },
  "calendar.selector.show_meetings": { nl: "Meetings tonen", en: "Show meetings" },
  "calendar.selector.connect_first": { nl: "Koppel eerst Google Calendar", en: "Connect Google Calendar first" },
  "calendar.selector.pick": { nl: "Kies welke agenda's je toont", en: "Pick which calendars to show" },
  "calendar.selector.calendars": { nl: "Agenda's", en: "Calendars" },
  "calendar.selector.pick_desc": { nl: "Kies welke Google-subagenda's de Hub-view voeden.", en: "Pick which Google subcalendars feed the Hub view." },
  "calendar.selector.load_failed": { nl: "Laden van agenda's mislukt", en: "Failed to load calendars" },
  "calendar.selector.none_found": { nl: "Geen agenda's gevonden op dit account.", en: "No calendars found on this account." },
  "calendar.selector.primary": { nl: "Primair", en: "Primary" },
  "calendar.toggle.hide": { nl: "{label} verbergen", en: "Hide {label}" },
  "calendar.toggle.show": { nl: "{label} tonen", en: "Show {label}" },
  "calendar.reschedule_failed": { nl: "Herplannen van taak mislukt", en: "Failed to reschedule task" },
  "calendar.save_selection_failed": { nl: "Opslaan van selectie mislukt", en: "Failed to save selection" },
  "calendar.task.overdue_since": { nl: "(te laat sinds {date})", en: "(overdue since {date})" },
  "calendar.task.done_suffix": { nl: "(gedaan)", en: "(done)" },

  // Event dialog
  "calendar.event.load_failed": { nl: "Laden van event mislukt", en: "Failed to load event" },
  "calendar.event.delete_failed": { nl: "Verwijderen van event mislukt", en: "Failed to delete event" },
  "calendar.event.couldnt_load": { nl: "Kon event niet laden", en: "Couldn't load event" },
  "calendar.event.unknown_error": { nl: "Onbekende fout", en: "Unknown error" },
  "calendar.event.join_meet": { nl: "Deelnemen met Google Meet", en: "Join with Google Meet" },
  "calendar.event.open_in_gcal": { nl: "Openen in Google Calendar", en: "Open in Google Calendar" },
  "calendar.event.delete_confirm_title": { nl: "Dit event verwijderen?", en: "Delete this event?" },
  "calendar.event.delete_confirm_body": { nl: "Genodigden worden op de hoogte gebracht. Dit kan niet ongedaan gemaakt worden.", en: "Attendees will be notified. This can't be undone." },
  "calendar.event.attendee.organizer": { nl: "(organisator)", en: "(organizer)" },
  "calendar.event.attendee.you": { nl: "(jij)", en: "(you)" },
  "calendar.event.response.yes": { nl: "Ja", en: "Yes" },
  "calendar.event.response.no": { nl: "Nee", en: "No" },
  "calendar.event.response.maybe": { nl: "Misschien", en: "Maybe" },
  "calendar.event.response.awaiting": { nl: "In afwachting", en: "Awaiting" },
  "calendar.event.all_day_suffix": { nl: "hele dag", en: "all day" },
  "calendar.event.save_failed": { nl: "Opslaan van event mislukt", en: "Failed to save event" },
  "calendar.event.create_failed": { nl: "Aanmaken van event mislukt", en: "Failed to create event" },
  "calendar.event.edit_title": { nl: "Event bewerken", en: "Edit event" },
  "calendar.event.new_title": { nl: "Nieuw event", en: "New event" },
  "calendar.event.save_changes": { nl: "Wijzigingen opslaan", en: "Save changes" },
  "calendar.event.create": { nl: "Aanmaken", en: "Create" },
  "calendar.event.field.title": { nl: "Titel", en: "Title" },
  "calendar.event.field.title_placeholder": { nl: "Voeg een titel toe", en: "Add a title" },
  "calendar.event.field.start": { nl: "Start", en: "Start" },
  "calendar.event.field.end": { nl: "Einde", en: "End" },
  "calendar.event.field.all_day": { nl: "Hele dag", en: "All day" },
  "calendar.event.field.location": { nl: "Locatie", en: "Location" },
  "calendar.event.field.location_placeholder": { nl: "Adres, ruimte of videolink", en: "Address, room, or video link" },
  "calendar.event.field.guests": { nl: "Genodigden", en: "Guests" },
  "calendar.event.field.email_placeholder": { nl: "email@example.com", en: "email@example.com" },
  "calendar.event.remove_attendee": { nl: "{email} verwijderen", en: "Remove {email}" },
  "calendar.event.field.description": { nl: "Omschrijving", en: "Description" },
  "calendar.event.field.description_placeholder": { nl: "Notities, agenda, links…", en: "Notes, agenda, links…" },
  "calendar.event.add_meet": { nl: "Google Meet-videocall toevoegen", en: "Add Google Meet video call" },

  // Task dialog
  "calendar.task.load_failed": { nl: "Laden van taak mislukt", en: "Failed to load task" },
  "calendar.task.update_failed": { nl: "Bijwerken van taak mislukt", en: "Failed to update task" },
  "calendar.task.couldnt_load": { nl: "Kon taak niet laden", en: "Couldn't load task" },
  "calendar.task.unknown_error": { nl: "Onbekende fout", en: "Unknown error" },
  "calendar.task.reopen_confirm_title": { nl: "Deze taak heropenen?", en: "Reopen this task?" },
  "calendar.task.reopen_confirm_body": { nl: "Hij gaat terug naar je queue met open taken.", en: "It will move back into your open tasks queue." },
  "calendar.task.reopen": { nl: "Heropenen", en: "Reopen" },
  "calendar.task.field.client": { nl: "Klant", en: "Client" },
  "calendar.task.field.assignee": { nl: "Toegewezen aan", en: "Assignee" },
  "calendar.task.field.author": { nl: "Auteur", en: "Author" },
  "calendar.task.field.source": { nl: "Bron", en: "Source" },
  "calendar.task.open_in_inbox": { nl: "Openen in Inbox", en: "Open in Inbox" },
  "calendar.task.mark_done": { nl: "Markeer als gedaan", en: "Mark done" },
  "calendar.task.status.open": { nl: "Open", en: "Open" },
  "calendar.task.status.in_progress": { nl: "Bezig", en: "In progress" },
  "calendar.task.status.done": { nl: "Gedaan", en: "Done" },
  "calendar.task.status.cancelled": { nl: "Geannuleerd", en: "Cancelled" },
  "calendar.task.status.unread": { nl: "Ongelezen", en: "Unread" },
  "calendar.task.status.read": { nl: "Gelezen", en: "Read" },
