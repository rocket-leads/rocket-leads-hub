...
export const DICTIONARY = {
  ...
  "billing.invoice.mode_monthly_hint": { nl: "Terugkerende factuur - schuift de betaaldatum van de klant op bij verzenden.", en: "Recurring invoice - advances the client's payment date on send." },
  ...
  "billing.invoice.next_payment_date": { nl: "Volgende betaaldatum", en: "Next payment date" },
  "billing.invoice.next_payment_after": { nl: "na deze factuur · nu {date}", en: "after this invoice · currently {date}" },
  "billing.invoice.next_payment_hint": { nl: "Standaard +1 maand. Zet +2 of +3 maanden voor kwartaalklanten. Factuur gaat 7 dagen voor deze datum de deur uit, en bepaalt de periode op de factuurregels.", en: "Defaults to +1 month. Set +2 or +3 months for quarterly clients. The invoice goes out 7 days before this date, and it sets the period shown on the invoice lines." },
