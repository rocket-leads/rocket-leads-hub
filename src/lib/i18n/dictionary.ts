...
export const DICTIONARY = {
  ...
  "billing.invoice.next_payment_hint": { nl: "Standaard +1 maand. Zet +2 of +3 maanden voor kwartaalklanten. Factuur gaat 7 dagen voor deze datum de deur uit.", en: "Defaults to +1 month. Set +2 or +3 months for quarterly clients. Invoice goes out 7 days before this date." },
