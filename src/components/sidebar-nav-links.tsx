...
import { Users, Eye, Target, Settings, Inbox, CreditCard, Home, ClipboardCheck, Calendar, TrendingUp } from "lucide-react"

// lucide's `Receipt` ships a $ glyph - off-brand for a €-Hub, so Billing uses
// `CreditCard`. Home uses the literal house glyph (Roy 2026-05-21).
const ICONS = { Users, Eye, Target, Settings, Inbox, CreditCard, Home, ClipboardCheck, Calendar, TrendingUp }
