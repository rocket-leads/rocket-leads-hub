...
export function FiltersPopover({ filters, align = "start" }: Props) {
  ...
  return (
    <Popover>
      <PopoverTrigger
        className={`inline-flex items-center gap-1.5 h-8 rounded-lg border border-border bg-background px-3 text-xs font-medium transition-colors hover:bg-muted/60 outline-none focus-visible:ring-2 focus-visible:ring-primary/30 ${
