...
// reverted the 2026-05-22 "include today" variant so the Watch List
// matches the Home-tab pill, every preset, and Monday's "last week".
// The today-inclusive window dropped the first labelled day (leads under
// -reported) while today's partial snapshot added nothing back. Trade-off:
// a lead landing today is visible the next morning, not same-day. Must
// stay identical to getLast7DaysRange in kpi-summaries + refresh-cache.
