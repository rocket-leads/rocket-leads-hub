...
- **Variant A = "Copy of winning"**: maximaal 90% woord-voor-woord identiek aan de source. Headline = exact dezelfde tekst als source headline (of een minimale herformulering). Primary copy = bijna identiek, alleen kleine stijlpolissh (1-2 zinsdelen mogen vernieuwen). USPs = WOORD-VOOR-WOORD overnemen. Dit is de "veilige" baseline iteratie - de CM moet deze direct kunnen herkennen als "dat is gewoon mijn ad". Doel: A/B test waar slecht de creative wisselt en de copy nagenoeg gelijk blijft. **De label voor deze variant MOET letterlijk "Variant A - Copy of winning" zijn — niet "Near-verbatim", niet een andere naam.**
