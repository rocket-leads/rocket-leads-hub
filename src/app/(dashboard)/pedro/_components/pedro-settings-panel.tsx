        ...
        <div className="divide-y divide-border/60">
          ...
          <Section title="Bronnen">
            <div className="space-y-4">
              {/* Inspiration root URL */}
              <div>
                <Label>Inspiration root (Drive folder URL)</Label>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    value={rootDraft}
                  ...
                  <div className="mt-2 text-xs">
                    {verifyState.connected ? (
                      <span className="inline-flex items-center gap-1 text-emerald-600 dark:text-emerald-400">
                        <CheckCircle2 className="h-3.5 w-3.5" />
                        Verbonden — {verifyState.subfolders.filter((s) => s.found).length} subfolders gevonden
                        <a
                          href={`https://drive.google.com/drive/folders/${verifyState.folderId}`}
                          target="_blank"
                          rel="noreferrer"
                          className="ml-1 text-muted-foreground hover:text-foreground inline-flex items-center gap-0.5"
                        >
                      ...
                      <span className="inline-flex items-center gap-1 text-amber-600 dark:text-amber-400">
                        <AlertCircle className="h-3.5 w-3.5" />
                        Niet bereikbaar: {verifyState.error ?? "Drive error"}
                      </span>
                    ) : (
