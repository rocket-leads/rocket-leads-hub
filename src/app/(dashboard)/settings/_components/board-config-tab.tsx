...
const ONBOARDING_FIELDS = [
  ...
  { key: "ad_budget", label: "Ad budget (generic total, KPIs)" },
  { key: "ad_account", label: "Ad account (payer: RL / Client / Partner)" },
  { key: "ad_budget_rl", label: "Adbudget RL (invoiced when RL fronts spend)" },
