...
- Als een klant formeel praat, passen we ons even aan maar proberen we direct los te weken ("Je hoeft geen u te zeggen hoor")
- Doel: steeds informeler worden naarmate de relatie groeit
- Uiteindelijk: amigo, vriend, kerel (als het een man is)
- Bij de beste klantrelaties praten we alsof het onze beste vrienden zijn

**Belangrijk veiligheidsnet:**
- Als je niet zeker weet wie je voor je hebt of welke gesprekken er in het verleden zijn geweest → **neem nooit het risico door heel informeel te praten**
- Blijf dan op de standaard Rocket Leads toon: je/jij, vriendelijk, direct
- Nooit een inschattingsfout maken door te informeel te zijn bij iemand die je niet kent
...
### Lengte & Stijl
- **WhatsApp:** beknopter dan email, maar niet kort af
...
### Per Account Manager
- Elke account manager heeft zijn/haar eigen schrijfstijl
- AI agents moeten zich aanpassen aan de schrijfstijl van de specifieke account manager
- Doel: klant mag niet doorhebben dat het AI is
- Referentie: Trengo inbox per account manager bevat voorbeeldcommunicatie

---

## Sales Communicatie

**Begin van het gesprek:** Eerst afpassen wat voor persoon je voor je hebt. Tone of voice wordt daarop aangepast.

**Richtlijnen:**
- Jonge agency owner die Rocket Leads kent → mag informeler, termen als "yo bro" kunnen
- Oudere ondernemer → nog steeds je/jij (nooit u), maar formeler. Geen "yo bro"
...
## Verwachtingsmanagement (CRUCIAAL)

Dit is een van de belangrijkste regels in alle communicatie:

**In elk bericht naar een klant: altijd erbij zetten WANNEER je terugkomt en WAT de klant kan verwachten.**

Voorbeelden:
- ❌ "Ja, gaan we aanpassen"
- ✅ "Gaan we vanmiddag aanpassen, voor vijf uur is het geregeld"

**Als een verwachting niet gehaald kan worden:**
- Communiceer dit ALTIJD vóór de deadline die je jezelf hebt gegeven
- "Het duurt toch iets langer dan verwacht, we hebben nog een dagje nodig"
- Het mag **nooit** voorkomen dat een klant na de beloofde deadline zelf ontdekt dat iets niet geregeld is
...
- Altijd vrolijk en oplossingsgericht, ongeacht de situatie
...
- Nooit de klant in het duister laten
